...
<head>
    ...
    <title>{{ $title ?? 'Lawson Indonesia' }}</title>
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="{{ route('home') }}" class="brand-link">
                <span class="brand-text font-weight-light text-center">{{ $title ?? 'Lawson Indonesia' }}</span>
            </a>
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview" style="display: none;">
                                <li class="nav-item">
                                    <a href="/order_items" class="nav-link">
                                        <i class="fas fa-file"></i>
                                        <p>List Order Items</p>
                                    </a>
                                </li>
                            </ul>
                            <ul class="nav nav-treeview" style="display: none;">
